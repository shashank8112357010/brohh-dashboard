...
export function Home() {
  ...
  const [updatedStatistics, setUpdatedStatistics] =
    useState(statisticsCardsData)
      ...
      .then((response) => {
        ...
        const updatedCards = [
          ...
          },
          {
            ...
            footer: {
              label: 'last updated',
              value: influencer.lastUpdated || 'N/A'
            },
            icon: UserGroupIcon
          },
          {
            ...
            footer: {
              label: 'last updated',
              value: testimonial.lastUpdated || 'N/A'
            },
  ...
  return (
    <div className="mt-12">
      <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        {updatedStatistics.map(
          ({ title, value, lastUpdated, footer, icon: Icon }) => (
            <StatisticsCard
              key={title}
              title={title}
              value={
