...
export function DeleteModal({ open, handleOpen, deletedName, handleDeleteFreelancer }) {
    ...
    return (
        <>
            ...
            >
                <DialogHeader className="text-center block w-full">Do you wish to continue?</DialogHeader>
