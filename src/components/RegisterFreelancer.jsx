...
const RegisterFreelancer = ({ closeForm }) => {
  ...
  const handleFileInput = (selectedKey, selectedFile) => {
    ...
    dispatch(
      setFormValue({
        type: 'fill',
        data: { key: selectedKey, value: selectedFile }
      })
    )
  }
        ...
        <div className="mb-4 flex flex-col sm:flex-row w-full ">
          ...
          <div className="sm:w-1/2">
            ...
            <div className="md:ml-2">
              <div className="w-2/3">
                <label
                  className="block sm:ml-2 mb-2 sm:text-center text-sm  w-full font-medium text-gray-900 "
                  htmlFor="profile"
                >
                  Profile
                </label>
              ...
              <div className="flex items-center w-3/3">
                <label
                  htmlFor="profile"
                  className={`flex flex-col items-center justify-center w-32 h-[8rem] rounded-[50%] cursor-pointer bg-gray-200`}
                >
                  {/* //box image is showing  */}
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    {data.profile ? (
                      <img
                        className="w-[200px] h-[130px] object-cover rounded-full"
                  ...
                  <input
                    ...
                    type="file"
                    onChange={(e) =>
                      handleFileInput('profile', e.target.files[0])
                    }
                  />
                </label>
              </div>
